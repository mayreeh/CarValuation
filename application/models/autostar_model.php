...
class Autostar_Model extends CI_Model 
{
    ...
    public function menu($current_menu=NULL)
    {
    	...
    	{
            $html .= '<li><a href="'.base_url().'search?q="><i class="icon-search"></i> Valuation Reports</a></li>';
    		$html .= '<li><a href="'.base_url().'report"><i class="icon-file"></i> Create Valuation Report</a></li>';
            $html .= '<li><a href="'.base_url().'user"><i class="icon-user"></i> Manage Users</a></li>';
    	}
        else 
        {
            // Home page
            $html .= '<li><a href="'.base_url().'search?q="><i class="icon-search"></i>'.$this->session->userdata('name').' Reports</a></li>';
