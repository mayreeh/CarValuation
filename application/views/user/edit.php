...
<form action="<?php echo base_url() . 'user/update'; ?>" method="post" class="vertical">

	<!-- hidden field: user ID -->
	<input type="hidden" name="user_id" value="<?php echo $form_variables->id; ?>" />
	...
	<!-- new password -->
	<label for="password">New Password: <i class="icon-star required smaller"></i></label>
	<input type="password" name="password" id="password" class="w600px" placeholder="Password" autocomplete="off" />

	<!-- confirm new password -->
	<label for="confirm_password">Confirm New Password: <i class="icon-star required smaller"></i></label>
	<input type="password" name="confirm_password" id="confirm_password" class="w600px" placeholder="Confirm Password" autocomplete="off" />

	<!-- save changes -->
	<input type="submit" value="Update Account Details" class="blue" />
