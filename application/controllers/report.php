	...
	public function pdf($report_id=NULL, $search_term=NULL)
	{
		...
		else
		{
			...
			$html = '
				...
				<tr>
					<td colspan="2">
						<span class="green">ENGINE NO :  <strong> ' .  $report->engine_number . '</strong></span>
					</td>
					<td colspan="2">
				...
				<tr>
					<td colspan="2">
						<span class="green">CHASSIS NO:  <strong> ' .  $report->chassis_number . '</strong></span>
					</td>
					<td colspan="2">
				...
				<tr>
					...
					<td colspan="2">
						<span class="green">POLICY EXPIRY DATE:</span> <strong>' .  $policy_expiry_date   . '</strong>
					</td >
				</tr>';
			...
			<table width="100%" class="border_table" >
				...
				<tr>
					<td colspan="4">
						<span class="red">ASSESSED VALUE:</span> <strong style="font-size:20px;" class="red">' .  $report->assessed_value_number   . '</strong>
					</td >
				</tr>
				<tr>
					<td colspan="4">
						<span class="red">AMAOUNT IN WORDS:</span> <strong style="font-size:20px;" class="red">' .  $report->assessed_value_words   . '</strong>
					</td >
				</tr>
				<tr>
					<td colspan="4">
						<span class="green">WIND SCREEN:</span> <strong> '.$report->note_value .' </strong>
					</td >
				</tr>
				<tr>
					<td colspan="4">
						<span class="green">RADIO:</span> <strong> '.$report->note_value .' </strong>
					</td >
				</tr>
				...
				$html .= '
					<tr>
						<td colspan="4" ><u><strong>FOR OFFICIAL USE ONLY</strong></u></strong></td>
					</tr>
					<tr>
						<td colspan="4" ><span class="green">VALUATION OFFICER : <strong>' .  $report->valuation_officer . '</strong></span></td>
					</tr>
					<tr>
						<td colspan="2">
        ...
        <tr>
				...
				$html .='	<p class="red"><em>Photos-</em></p>';
